...
const jwt = require('jsonwebtoken'); // <-- নতুন যোগ করা হয়েছে
...
// একটি গোপন কী যোগ করা হয়েছে যা টোকেন তৈরি এবং যাচাই করতে ব্যবহৃত হবে
...
app.post('/login', async (req, res) => {
    try {
        ...
        // --- নতুন পরিবর্তন এখানে ---
        // যদি সবকিছু ঠিক থাকে, তাহলে একটি JWT টোকেন তৈরি করুন
        const accessToken = jwt.sign(
            { 
                email: user.email, 
                role: user.role,
                fullName: user.fullName // ব্যবহারকারীর নামও টোকেনে যোগ করা হলো
            }, 
            JWT_SECRET, 
            { expiresIn: '7d' } // টোকেনটি ৭ দিন পর্যন্ত বৈধ থাকবে
        );

        res.status(200).json({
            success: true,
            message: "লগইন সফল হয়েছে!",
            token: accessToken, // <-- আগের user অবজেক্টের বদলে এখন টোকেন পাঠানো হচ্ছে
        });
        // --- পরিবর্তন শেষ ---
